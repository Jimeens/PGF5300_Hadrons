    ...
    \begin{multicols}{2}
        ...
        \begin{center}
            \begin{tikzpicture}
                \begin{feynman}
                    \vertex (i1);
                    \vertex [below right=0.7*1.5cm and 0.7*2cm of i1, dot] (i2) {};
                    \vertex [above right=0.7*1.5cm and 0.7*2cm of i2] (i3);
                    
                    \vertex [below=0.7*6cm of i1] (i4);
                    \vertex [above right=0.7*1.5cm and 0.7*2cm of i4, dot] (i5) {};
                    \vertex [below right=0.7*1.5cm and 0.7*2cm of i5] (i6);
...
\begin{exercise}{}
    Vimos que a amplitude DVCS (deeply-virtual Compton scattering) é dada por
        ...
        \end{equation*}
    \begin{enumerate}[(a)]
        \item Partindo da expressão acima, mostre que $\text{Im}[T_{\alpha\beta}] = 2\pi W_{\alpha\beta}$, ou seja, que a parte imaginária da amplitude DVCS é proporcional ao tensor hadrônico do espalhamento inélástico profundo.
        \item Usando um conjunto completo de estados intermediários entre as correntes eletromagnéticas, argumente por quê
            ...
            \end{equation*}
        é igual a zero. \textbf{\textsc{Dica:}} obtenha uma função delta de Dirac e conservação do quadri-momento total.
    \end{enumerate}
\end{exercise}
