...
Analizando a delta de Dirac de conservação de momento, temos pela conservação do 4-momento, vale a igualdade $p_{X} = p + q$. O argumento da Delta vai ficar então
    \begin{equation*}
