...
Analizando a delta de Dirac de conservação de momento, temos pela conservação do 4-momento, vale a igualdade $p_{X} = p + q$. No argumento da Delta, vai ficar então
    \begin{equation*}
        \delta^{4}(q + p_{X} - p) = \delta^{4}(2q)
    \end{equation*}